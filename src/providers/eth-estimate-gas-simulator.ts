...
import { OptimismGasData, ArbitrumGasData } from "./v3/gas-data-provider";
import { IV3PoolProvider } from "./v3/pool-provider";

export class EthEstimateGasSimulator extends Simulator {
    v2PoolProvider: IV2PoolProvider
    v3PoolProvider: IV3PoolProvider
    constructor(chainId: ChainId, provider: JsonRpcProvider, v2PoolProvider: any, v3PoolProvider: any) {
