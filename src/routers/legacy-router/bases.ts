...
export const BASES_TO_CHECK_TRADES_AGAINST = (
  ...
  return {
    ...
    [ChainId.NIZA_TESTNET]: [WRAPPED_NATIVE_CURRENCY[ChainId.NIZA_TESTNET], NIZA_TESTNET_USDC, NIZA_TESTNET_USDT, NIZA_TESTNET_DAI, NIZA_TESTNET_WBTC, NIZA_TESTNET_WETH!],
    [ChainId.NIZA]: [WRAPPED_NATIVE_CURRENCY[ChainId.NIZA]!], USDC_NIZA, USDT_NIZA, DAI_NIZA
  };
};
