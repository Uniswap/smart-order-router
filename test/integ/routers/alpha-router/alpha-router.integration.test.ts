...
import { InMemoryRouteCachingProvider } from '../../../unit/providers/caching/route/test-util/inmemory-route-caching-provider';
import { getInvalidCachedRoutesStub } from '../../../unit/routers/alpha-router/gas-models/test-util/mocked-dependencies';
    ...
    describe(`${ID_TO_NETWORK_NAME(1)} alpha - ${tradeType.toString()}`, () => {
      ...
      it(`erc20 -> erc20 cached routes cache invalidation`, async () => {
        ...
        await routeCachingProvider.setCachedRoute(
          getInvalidCachedRoutesStub(FORK_BLOCK)!,
          ...
          describe(`Simulate + Swap ${tradeType.toString()}`, function () {
            ...
            it(`${wrappedNative.symbol} -> erc20`, async () => {
              ...
              const amount =
                tradeType == TradeType.EXACT_INPUT
                  ...
                  : parseAmount(
                      chain === ChainId.UNICHAIN_SEPOLIA ? '0.001' : '10',
                      tokenOut
                    );
              ...
              console.log(
                ...
                } ${swapWithSimulation!.estimatedGasUsed.toNumber()} ${swap!.estimatedGasUsed.toNumber()}`
              );
              expect(
                percentDiff.lte(
            ...
            it(`${native} -> erc20`, async () => {
              ...
              const amount =
                tradeType == TradeType.EXACT_INPUT
                  ? parseAmount(
                      chain === ChainId.WORLDCHAIN ? '0.001' : '1',
                      tokenIn
                    )
                  : parseAmount('1', tokenOut);
